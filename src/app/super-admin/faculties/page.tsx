...
import { getFaculties, deleteFaculty } from "@/lib/actions/super-admin";
    ...
    { header: "Actions", accessor: "id", render: (f: any) => (
      <button
        onClick={() => setModal({
          ...
          description: `Are you sure you want to delete ${f.name}? This will remove associated subjects.`,
          action: async () => { await deleteFaculty(f.id); loadFaculties(); }
        })}
